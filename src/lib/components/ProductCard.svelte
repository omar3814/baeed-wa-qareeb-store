<!-- === Code for src/lib/components/ProductCard.svelte (Passes Position Prop) === -->
<script lang="ts">
	...
	function openModal(event: MouseEvent) {
		...
		modalPosition = { top: rect.top, left: rect.left, width: rect.width, height: rect.height };
		showModal = true;
	}
...
<style> .price-glow { text-shadow: 0 0 5px rgba(192, 132, 252, 0.4); } </style>